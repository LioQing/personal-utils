...
private:
    ...
    inline static std::array<void*, LIC_MAX_COMPONENT> components;

    // Vector of destroyed components
    inline static std::array<std::vector<std::size_t>, LIC_MAX_COMPONENT> destroyed_components;

    // Vector of on component destroy callback functions
    inline static std::array<std::vector<std::vector<std::function<void()>>>, LIC_MAX_COMPONENT> on_component_removals;

    // Vector of entities infos
    inline static std::vector<EntityInfo> entities;

    // Vector of destroyed entity IDs
    inline static std::vector<EntityID> destroyed_entities;

    // Next component ID to be generated
    inline static ComponentID next_component_id;

    // Next entity ID to be generated
    inline static EntityID next_entity_id;
...
inline void lic::Entity::RemoveComponent(ComponentID cid) const
{
...
inline bool lic::Entity::HasComponent(ComponentID cid) const
{
...
inline void lic::Entity::OnComponentRemoval(ComponentID cid, const std::function<void()>& callback) const
{
