...
StringIterator StringIterator_begin(String* vec)
{
	return StringIterator_construct(vec, 0);
}

StringIterator StringIterator_end(String* vec)
{
	return StringIterator_construct(vec, vec->size);
}
